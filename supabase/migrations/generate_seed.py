...
for idx, ex in enumerate(exercises):
    id_val, nome, nome_alt, gp, pm, nivel = ex
    ...
    prev = "NULL"
    nxt = "NULL"
    # Find previous/next logic
    # Just basic links to satisfy schema. It can be refined later.
    
    desc_json = json.dumps('[REVISAR: conteúdo a ser adicionado]')
    
    stmt = f"""INSERT INTO exercicios (
...
with open('c:/Users/user/Documents/Projetos/Hypertropos/hypertropos/supabase/migrations/20260520000002_seed_exercicios.sql', 'w', encoding='utf-8') as f:
    f.write("\n".join(sql_statements))
